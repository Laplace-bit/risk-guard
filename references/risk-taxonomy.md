...
- Payment is non-reversible
- Environment is hazardous and controls are unconfirmed
- There is no communication, transport, or emergency fallback
- Counterparty uses stolen or synthetic identity
- Communication is restricted to a single platform with no verifiable offline identity
- Request for payment via gift cards, cryptocurrency, or wire transfer to an unknown recipient
